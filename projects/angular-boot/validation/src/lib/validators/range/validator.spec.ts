...
describe('Range [4, 9]', () => {
  ...
  it('"3" should equal to "{actualValue: 3, requiredValue: [4, 9], range: true}"', () => {
    ...
    expect(validator(control)).toEqual({actualValue: 3, requiredValue: [4, 9], nbvRange: true});
  });
  ...
  it('"10" should equal to "{actualValue: 3, requiredValue: [4, 9], range: true}"', () => {
    ...
    expect(validator(control)).toEqual({actualValue: 10, requiredValue: [4, 9], nbvRange: true});
  });
});
