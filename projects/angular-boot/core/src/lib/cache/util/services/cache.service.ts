...
const DEFAULT_STORAGE = CacheType.SESSION_STORAGE;
const DEFAULT_ENABLED_STORAGE = CacheType.MEMORY;
...
export class CacheService {
     ...
     */
    public useStorage(type: CacheType) {
     ...
     */
    private _initStorage(type: CacheType) {
